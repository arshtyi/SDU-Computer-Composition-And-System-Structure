...
#exp-block[
    = 实验原理和方法
    == 实验原理
    使用`*.coe`初始化ROM和RAM的内容:
    ```coe
    memory_initialization_radix=16;
    memory_initialization_vector=
    000FFC,007FFE,01FFFE,03FFFE,
    07FFFC,0FFFFC,1FFE38,3FF000,
    3FC001,7F8000,7F0000,FF0000,
    FE0000,FE0000,FE0000,FC0000,
    FC0000,FE0000,FE0000,FE0000,
    FE0000,7F0000,7F8000,3FC000,
    3FE001,1FF800,0FFFF8,0FFFF8,
    07FFFC,01FFFC,00FFFC,003FFC,
    0003E0;
    ```
    ```coe
    memory_initialization_radix = 16;
